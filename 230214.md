...
Function: 특정 기능을 수행하는 코드 조각 / 가독성 이유로 사용한다.
...
Function Notation             함수         지칭 vs 호출      다르다
...
느낌점
문법의 지식을 더 딥하게 공부하는 습관, 스스로 문제를 만들어서 연습이 필요하다. 또한 옳바른 코딩 습관을 만들고 있다. 
띄어쓰기, Naming Convention, 등등 신경 쓰고 있다.
